...
namespace LView.CMS.ViewModels
{
    public class ResultCodeAddMsgKeys
    {
        ...
        /// 数据状态发生的信息
        /// </summary>
        public const string CommonDataStatusChangeMsg = "数据状态发生变化，请刷新后再进行操作";
        ...
        /// 用户名或密码错误消息
        /// </summary>
        public const string SignInPasswordOrUserNameErrorMsg = "用户名或密码错误";
        ...
        /// 用户被锁定消息
        /// </summary>
        public const string SignInUserLockedMsg = "您的账号已被锁定，请联系管理员";
        ...
        /// 旧密码输入错误编码
        /// </summary>
        public const int OldPasswordErrorCode = 206;

        /// <summary>
        /// 旧密码输入错误消息
        /// </summary>
        public const string OldPasswordErrorMsg = "旧密码输入错误";
        #endregion
    }
}
